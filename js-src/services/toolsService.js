class ToolsService {
	static doByClassName = function(className, cb) {
	...
	static getRandomNumber = function() {
		return Math.floor((Math.random() * 9999999) + 1111111);
	}

	static getRandomFloat = function(min, max, decimals) {
	...
	static getRandomArrayValue = function(array){
		var choose = [];
	...
	static getFromWarmColors = function(){
		...
		return ToolsService.getRandomArrayValue(colors);
	}
}
